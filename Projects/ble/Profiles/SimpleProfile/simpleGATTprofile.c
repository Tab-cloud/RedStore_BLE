...
//                                    INVALID_TASK_ID );
        ...
        pReport.len = 20;
        pReport.value[0] = 0Xaa;//赋值
        pReport.value[1] = 0x01;//赋值
        pReport.value[2] = 0x02;//赋值
        pReport.value[3] = 0x03;//赋值
        pReport.value[4] = 0x04;//赋值
        pReport.value[5] = 0x05;//赋值
        pReport.value[6] = 0x06;//赋值
        pReport.value[7] = 0x07;//赋值
        pReport.value[8] = 0x08;//赋值
        pReport.value[9] = 0x09;//赋值
        pReport.value[10] = 0x10;//赋值
        pReport.value[11] = 0x11;//赋值
        pReport.value[12] = 0x12;//赋值
        pReport.value[13] = 0x13;//赋值
        pReport.value[14] = 0x14;//赋值
        pReport.value[15] = 0x15;//赋值
        pReport.value[16] = 0x16;//赋值
        pReport.value[17] = 0x17;//赋值
        pReport.value[18] = 0x18;//赋值
        pReport.value[19] = 0xbb;//赋值
...
//******************************************************************************                  
//name:             GZ_SimpleGATTprofile_Char6_Notify                 
...
//return:           none                                    
//******************************************************************************     
void GZ_SimpleGATTprofile_Char6_Notify(uint16 nGUA_ConnHandle, uint8 *pGUA_Value, uint8 GUA_DATA_PACKAGE_LEN)    
{    
  ...
  {    
    ...
    stGUA_Noti.len = GUA_DATA_PACKAGE_LEN;    
    osal_memcpy(stGUA_Noti.value, pGUA_Value, GUA_DATA_PACKAGE_LEN);
